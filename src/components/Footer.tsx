      ...
      <div className="container mx-auto px-4">
        <Row gutter={[32, 32]}>
          ...
          <div className="w-[100px] h-[90px] max-h-[90px] flex justify-center rounded-lg items-center mb-4 bg-white relative overflow-hidden">
            ...
            <p className="text-lg font-semibold italic mb-4 font-exo text-white">"The right knowledge, a bright future."</p>
          </div>
          ...
          <Col xs={24} sm={12} md={5} lg={5} xl={5}>
            ...
            <Space direction="vertical" className='font-jost'>
              ...
              <a href="/" className="text-gray-300 hover:text-white">Latest Articles</a>
              <a href="/FAQs" className="text-gray-300 hover:text-white">FAQ</a>
            </Space>
          </Col>
          <Col xs={24} sm={12} md={5} lg={5} xl={5}>
            <h2 className="text-xl font-bold mb-4 text-white" >Programs</h2>
            <Space direction="vertical" className='font-jost'>
              <a href="/" className="text-gray-300 hover:text-white">Art & Design</a>
              <a href="/" className="text-gray-300 hover:text-white">Business</a>
              <a href="/" className="text-gray-300 hover:text-white">IT & Software</a>
              <a href="/" className="text-gray-300 hover:text-white">Languages</a>
              <a href="/" className="text-gray-300 hover:text-white">Programming</a>
            </Space>
          </Col>
        ...
        <Row justify="center">
          <Col>
            <Text className="text-sm text-gray-400">
              Copyright © {new Date().getFullYear()} Learn At Edu Master for your future | Powered by Team 3
            </Text>
          </Col>
        </Row>
      </div>
