...
export const ProofOfProduct = () => {
    return (
        <div className="py-10 grid gap-6 grid-cols-4 grid-rows-3 justify-between duration-700 transition-all">
            <Card
              ...
              hoverable
            >
              <h3 className=" text-5xl font-semibold">25K+</h3>
              <p>Active Students</p>
            </Card>
            <Card
              ...
              hoverable
            >
              <h3 className=" text-5xl font-semibold">888+</h3>
              <p>Total Courses</p>
            </Card>

            <div className="row-span-3 col-span-2 ml-auto"><img src={happyDude} alt="smiling guy" ></img></div>
            ...
            <Card
              ...
              hoverable
            >
              <h3 className="text-5xl font-semibold">253+</h3>
