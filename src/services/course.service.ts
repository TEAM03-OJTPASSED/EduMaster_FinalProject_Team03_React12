...
import { Course, CourseStatusUpdate, CourseRequest, GetCourses, GetCourseLogs, CourseLog } from "../models/Course.model";
...
const CourseService = {
    ...
    updateCourse(courseId: string, params: CourseRequest): Promise<ApiResponse<Course>> {
