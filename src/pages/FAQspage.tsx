    ...
    <div>
      ...
      <section className="pt-5">
              ...
              {openFAQ === 1 && (
                <div className="mt-4 text-gray-700">
                  <p className="text-lg">
                    ...
                    <a href="https://thimpress.com/improve-website-speed-wordpress-website-slow-fix/"
                      target="_blank"
                      rel="noopener" className="hover:text-orange-400 font-semibold"> Read this article carefully</a>
        ...
        <div className="pl-4 pr-4 mt-7" >
          <img src="https://ucarecourse.com/wp-content/uploads/2023/02/faqs.png" alt="" />
        </div>
      </section>
