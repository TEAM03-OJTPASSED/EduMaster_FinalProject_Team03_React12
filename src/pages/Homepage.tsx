...
const categories: Category[] = [
  { icon: <FaPalette className="text-4xl text-orange-500" />, title: 'Art & Design', courses: 38 },
  { icon: <FaCode className="text-4xl text-orange-500" />, title: 'Development', courses: 38 },
  { icon: <FaComments className="text-4xl text-orange-500" />, title: 'Communication', courses: 38 },
  { icon: <FaVideo className="text-4xl text-orange-500" />, title: 'Videography', courses: 38 },
  { icon: <FaCamera className="text-4xl text-orange-500" />, title: 'Photography', courses: 38 },
  { icon: <FaChartLine className="text-4xl text-orange-500" />, title: 'Marketing', courses: 38 },
  { icon: <FaPenNib className="text-4xl text-orange-500" />, title: 'Content Writing', courses: 38 },
  { icon: <FaChartPie className="text-4xl text-orange-500" />, title: 'Finance', courses: 38 },
  { icon: <FaAtom className="text-4xl text-orange-500" />, title: 'Science', courses: 38 },
  { icon: <FaNetworkWired className="text-4xl text-orange-500" />, title: 'Network', courses: 38 },
];
      ...
      <main className="w-full text-left overflow-visible ">
        <section className="relative lg:h-[400px] h-[300px] w-[115vw] -ml-[15vw] flex justify-center items-center flex-col space-y-4  bg-black overflow-y-hidden">
          ...
          <div className="z-50 w-[400px] text-white text-center italic">
            "All the courses you need, all in one place." Get started today to unlock your hidden potential!
          </div> 
            ...
            <div className="container mx-auto px-4">
              <div className="flex justify-between items-center mb-8">
                <div>
                  ...
                  <p className="text-gray-600 mt-2">Explore our Popular Categories</p>
                </div>
                <Button type="default" className="hover:bg-orange-500 hover:text-white transition-colors">
                  All Courses
                </Button>
                </div>
