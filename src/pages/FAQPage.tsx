          ...
          <div className="p-4 w-full md:w-1/2">
            ...
            <div className="pt-5 pb-5 px-4 sm:px-7 mb-5 bg-gray-100 rounded-md">
              ...
              {openFAQ === 2 && (
                <div className="mt-4 text-gray-700 text-sm sm:text-base">
                  <p>
                    Piracy of Digital <strong>Content </strong> is now one of
                    the most irritating problems regarding copyright and selling
                    products online. There’s no way to 100% prevent others from
                    stealing your content, but you can make it harder for them
                    to copy your{" "}
                    <strong>
                      <a
